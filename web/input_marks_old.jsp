...
footer {
  ...
  <%
        ...
        String squery2="select * from subjects where Semester='"+sem+"' and programme_code='"+Course+"' and branch_code='"+department+"'";
        res4=st.executeQuery(squery2);
        Statement st2=(Statement)con1.createStatement();
        ResultSet rs4=st2.executeQuery("Select * from marks where Eno_num='"+eno+"'");
      ...
      <div class="b">
          <form name="form" action="MarksServlet" method="post" >
              <div id="subBox"> <%  out.println("<h4>");  String sub=res4.getString("Subject_name"); out.println(sub);
%>
          <input class = "newclass" type="text" name="tnp"><br><br>
        ...
        <%
            if(!rs4.next())
    {
        String sub_code=res4.getString("Subject_code");
