...
public class PostGradPOJO 
{
    ...
    String GraduationUniversity ="", GraduationCollege ="", Graduation_Stream="";
    Double Graduation_Percentage;
    int Graduation_Year;
    ...
    public Double getGraduation_Percentage() {
        return Graduation_Percentage;
    }

    public void setGraduation_Percentage(Double Graduation_Percentage) {
